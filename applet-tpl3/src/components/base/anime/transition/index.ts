...
Component({
  ...
  properties: {
    ...
    enterStyle: { type: String, value: '' },
    enterActiveStyle: { type: String, value: '' },
    exitStyle: { type: String, value: '' },
    exitActiveStyle: { type: String, value: '' },
    // 上面的同之前提到的各个动画的 class，只不过这是 style
    /** 对应 position-class，是位置的样式字符串 */
    positionStyle: { type: String, value: '' },
  },
  observers: {
